...
<div class="container">
    <div class="row f_publish">
        <h3 class="publish_title"><img src="<?php echo $home; ?>images/fb2.png" alt="">求购发布<span>发布额度求购信息</span></h3>
        <div class="row flower_form">
            <div class="col-sm-2 col-xs-6">
                <label for="" class="form_name"><span>*</span>求购类别：</label>
            </div>
        ...
        <div class="row flower_form">
            <div class="col-sm-2 col-xs-6">
                <label for="" class="form_name"><span>*</span>求购额度：</label>
            </div>
